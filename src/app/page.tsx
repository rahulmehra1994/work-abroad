        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <div className="mb-10 md:mb-16">
            ...
            <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
              We handle the paperwork, legal requirements, and job
              arrangements—so you can focus on starting your new career abroad.
            </p>
          </div>
          {/* <!-- text - end --> */}
        ...
        <div className="container px-5 py-24 mx-auto flex">
          <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
            <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">
              Contact us - send us your any query.
            </h2>
            <p className="leading-relaxed mb-5 text-gray-600">
              Please feel free to reach out. We will try our level best to help
              you.
            </p>
            ...
            <p className="text-xs text-gray-500 mt-3">
              We generally revert the query in 2 working days.
            </p>
          </div>
        </div>
      </section>
